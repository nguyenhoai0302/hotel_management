...
<body>
    <div class="nav">
        ...
        <div class="nav_text"><a class="nav_text" href="index">HOME</a></div>
        <div class="nav_text"><a class="nav_text" href="index.php?controller=about">ABOUTS US</a></div>
        <div class="nav_text"><a class="nav_text" href="index.php?controller=rooms&action=room">ROOMS</a></div>
        ...
        ?>
            <div class="nav_log nav_text">
                <div class="nav_text"><a class="nav_text" href="index.php?controller=login">SIGN IN</a></div>

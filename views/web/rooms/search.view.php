...
<body>
    ...
    <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
        ...
        <h1 class="mt-4 mb-5 title-explore_our_rooms display-3"><b>Result for</b> <span class="title-explore_our_rooms " style="color:#FFC300 ;"><b><?php echo isset($_GET['keyword']) ? htmlspecialchars($_GET['keyword']) : '';?></b></span></h1>
    </div>
    <!-- row 2-->

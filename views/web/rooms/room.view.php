    ...
    <div class="row mt-3 mb-4 g-4 p-5" id="pp">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="room-item shadow rounded overflow-hidden">
                <div class="position-relative">
                    <a href="detail.html">
                    <img id="img7" src="/assets/web/images/anh23.png" alt="" width="100%" height="350px">
                    </a>
                </div>
                <div class=" room p-4 mt-1">
                    <div class="d-flex justify-content-between mb-3">
                        <h5 class="mb-0">Room 105</h5>
                        <img src="/assets/web/images/star.png" alt="star"width="25%" height="40px">
                    </div>
                    <div class="d-flex mb-3">
                        <small class="border-end me-3 pe-3"><i class="fa fa-bed" aria-hidden="true"></i>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="room-item shadow rounded overflow-hidden">
                <div class="position-relative">
                    <a href="detail.html">
                    <img id="img8" src="/assets/web/images/anh24.png" alt="" width="100%" height="350px">
                    </a>
                </div>
                <div class="room p-4 mt-1">
                    <div class="d-flex justify-content-between mb-3">
                        <h5 class="mb-0">Room 106</h5>
                        <img src="/assets/web/images/star.png" alt="star"width="25%" height="40px">
                    </div>
                    <div class="d-flex mb-3">
                        <small class="border-end me-3 pe-3"><i class="fa fa-bed" aria-hidden="true"></i>
    ...
    <div class="row mt-3 mb-4 g-4 p-5 " id="pp">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="room-item shadow rounded overflow-hidden">
                <div class="position-relative">
                    <a href="detail.html">
                    <img id="img7" src="/assets/web/images/anh27.png" alt="" width="100%" height="350px">
                    </a>
                </div>
                <div class=" room p-4 mt-1">
                    <div class="d-flex justify-content-between mb-3">
                        <h5 class="mb-0">Room 108</h5>
                        <img src="/assets/web/images/star.png" alt="star"width="25%" height="40px">
                    </div>
                    <div class="d-flex mb-3">
                        <small class="border-end me-3 pe-3"><i class="fa fa-bed" aria-hidden="true"></i>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="room-item shadow rounded overflow-hidden">
                <div class="position-relative">
                    <a href="detail.html">
                    <img id="img8" src="/assets/web/images/anh28.png" alt="" width="100%" height="350px">
                    </a>
                </div>
                <div class="room p-4 mt-1">
                    <div class="d-flex justify-content-between mb-3">
                        <h5 class="mb-0">Room 109</h5>
                        <img src="/assets/web/images/star.png" alt="star"width="25%" height="40px">
                    </div>
                    <div class="d-flex mb-3">
                        <small class="border-end me-3 pe-3"><i class="fa fa-bed" aria-hidden="true"></i>

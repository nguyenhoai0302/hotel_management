            ...
            <div class="col-lg-6">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="payment_date" id="payment_date" style="width:500px;" value="<?php echo date('Y-m-d'); ?>">
                    </div>
                    <div class="form-group">
                        <label for="amount">Amount:</label>
                        <input type="text" class="form-control" placeholder="Amount" name="amount" id="amount" value="<?php echo $amount ?>" style="width:500px;" disabled>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary btn-block" name="payment">Pay Now</button>
            </div>
        </div>
    </div>
</body>

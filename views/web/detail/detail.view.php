    ...
    <div class="container">
        <form action="" method="">
            <div class="row details_room">
                <!-- picture -->
                <div class="picture">
                    <img class="img1 detail_img" id="img1" src="assets/uploads/rooms/<?php echo $room['image']; ?>" alt="Hình ảnh phòng 1">
                ...
                <div class="row content">
                    ...
                    <div class="col-lg-9 col-12">
                        ...
                        <div class="row content-text">
                            ...
                            <div class="col-lg-4 col-6 context__icon">
                                ...
                                <i id="icon_share_detail" class="fa-solid fa-share">
                                    <div id="addbag"></div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-12" id="booking-btn">
                        <a href="index.php?controller=booking$action=booking$roomId=<?php $room['id'] ?>"> Booking now
                            <!-- id="book1"><button id="booking_now" class="button_booking">BOOKING NOW</button></a> -->
                    </div>
                </div>
            </div>
        </form>

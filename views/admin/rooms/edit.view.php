                                    ...
                                    <div>
                                        <form method="POST" action="#" class="parsley-examples" data-parsley-validate=""
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="description" rows="3" name="description" value="<?php echo $oldRoom['description'];?>"></textarea>
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleSelect1">Status<span class="text-danger">*</span></label>
                                                <select class="form-control" id="status" name="status" value="<?php echo $oldRoom['status'];?>">

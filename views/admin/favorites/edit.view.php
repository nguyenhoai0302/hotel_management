                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Edit Favorite</h4>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                        ...
                                        <div>
                                            <form method="POST" action="#" class="parsley-examples" data-parsley-validate="" novalidate="" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="user_name" parsley-trigger="change" required="" placeholder="Enter name" class="form-control" id="user_name" value="<?php echo $oldFavorite['user_name'];?>" disabled>
                                                </div>
                                                
                                                <!-- Room Name -->
                                                <div class="form-group">
                                                    <label for="room_name">Room</label>
                                                    <input type="text" name="room_name" parsley-trigger="change" required="" placeholder="Enter name" class="form-control" id="room_name" value="<?php echo $oldFavorite['room_name'];?>" disabled>
                                                </div>

                                                <!-- Save/Cancel -->
                                                <div class="form-group text-right mb-0">
                                                    <button class="btn btn-primary waves-effect waves-light mr-1" type="submit" name="update">Save</button>
                                                    <a href="admin.php?controller=favorites&action=list"
